  ...
  implements OnInit, AfterContentChecked
{
  ...
  constructor(
    ...
    public resource: T, // 'resource' poderá ser um category ou um entry em nosso projeto
    protected resourceService: BaseResourceService<T>,
    protected jsonDataToResourceFn: (jsonData) => T // Converte um objeto do tipo json para um objeto que vc está trabalhando (Category ou Entry)
  ) {
